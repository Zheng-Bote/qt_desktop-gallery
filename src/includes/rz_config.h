...
#define PROG_VERSION "0.16.0"
#define PROG_HOMEPAGE "https://github.com/Zheng-Bote/qt_desktop-gallery"
#define PROG_DESCRIPTION "Desktop gallery-app to show/edit Exif/IPTC/XMP and export to WebP"
#define PROG_ORGANIZATION_NAME "ZHENG Robert"
#define PROG_ORGANIZATION_DOMAIN "hase-zheng.net"
